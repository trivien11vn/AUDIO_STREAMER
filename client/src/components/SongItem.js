...
const SongItem = ({thumbnail, title, artists, release, sid, order, percent, style, smm}) => {
  const dispatch = useDispatch()
  order && console.log(smm)
  return (
    <div
      ...
      <div className='flex gap-4'>
        ...
        <img src={thumbnail} alt='thumbnail' className={clsx('rounded-md', smm ? 'w-[40px] h-[40px] object-cover ' : 'w-[60px] h-[60px] object-cover ')}/>
